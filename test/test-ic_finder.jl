...
@testset "IC_Finder-silicic" begin
    ...
    @test all(
        (eps_g0_3, X_co20_3, mco2_diss0_3, phase0_3) .≈ (eps_g, X_co2, mco2_diss, phase)
    )
...
@testset "IC_Finder-mafic" begin
    ...
    @test all((eps_g0, X_co20, mco2_diss0, phase0) .≈ (eps_g, X_co2, mco2_diss, phase))
    ...
    @test all([
        isapprox(a, b; atol=1e-12) for (a, b) in
        zip((eps_g0_3, X_co20_3, mco2_diss0_3, phase0_3), (eps_g, X_co2, mco2_diss, phase))
    ])
