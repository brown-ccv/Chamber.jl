...
function IC_Finder(composition::Silicic, M_h2o::T, M_co2::T, M_tot::T, P::T, Temp::T, V::T, rho_m::T, param_IC::ParamICFinder{T})::NamedTuple{(:eps_g0, :X_co20, :mco2_diss, :phase),NTuple{4,T}} where {T<:Float64}
    ...
    eps_g_guess = param_IC.eps_g_guess_ini
    X_co2_guess = param_IC.X_co2_guess_ini
    ...
    count = 0
    solve_X_co2′(eps_g0, X_co2_prev) = solve_X_co2(eps_g0, X_co2_prev, P, Temp, eps_x0, V, rho_m, rho_g, M_co2, Tol)
...
function IC_Finder(
    ...
    if phase == 2
        ...
        while (
            ...
            function fun(x)
                return real(
                    mco2_dissolved_sat(x, P, Temp) * (1 - eps_g0 - eps_x0) * V * rho_m +
            ...
            X_co20 = Xmean
            mwater_dissolved = meq_water(composition, X_co20, P, Temp)
            mco2_diss = mco2_dissolved_sat(X_co20, P, Temp)
