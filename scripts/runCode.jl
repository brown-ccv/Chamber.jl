...
function chamber(
    ...
    rheol::String="old",
) # ("silicic", 1e9, 0.2, 0.04, 0.001, -3.3, 8e3)
    ...
    @timeit to "chamber" begin
        ...
        if composition == "silicic"
            eps_g0, X_co20, C_co2, phase = IC_Finder_silicic(
                M_h2o_0,
                M_co2_0,
                M_tot,
                P_0,
        ...
        elseif composition == "mafic"
            eps_g0, X_co20, C_co2, phase = IC_Finder_mafic(
                M_h2o_0,
                M_co2_0,
                M_tot,
                P_0,
        ...
        function odeChamber(du, u, param, t)
            ...
            c =
                (1 / rho) *
                (rho_x * eps_x * c_x + rho_m * eps_m * c_m + rho_g * eps_g * c_g)
